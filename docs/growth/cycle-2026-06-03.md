...
- Top failure: GitHub API/keyring timeouts slowed fixture publishing, but retry succeeded.
...
- Iterate: Run Crosscheck on the public fixture PR, capture the BLOCK -> fix -> recheck proof, and update README with the proof asset once recorded.
