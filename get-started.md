...
# Retries required clone/fetch operations before a PR run fails.
# auto starts with Git defaults and falls back to HTTP/1.1 after HTTP/2 failures.
git:
  clone_attempts: 4
  retry_base_delay_ms: 2000
  https_version: auto       # auto | HTTP/2 | HTTP/1.1
