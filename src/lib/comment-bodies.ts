...
export function buildFixAppliedCommentBody(input: FixAppliedCommentInput): string {
  ...
  return [
    ...
    '',
    '---',
    '_Applied by Claude Code via [crosscheck](https://github.com/Motivation-Labs/crosscheck)._',
    '',
...
export function buildConflictResolvedCommentBody(input: ConflictResolvedCommentInput): string {
  ...
  return [
    ...
    '',
    '---',
    '_Resolved by Claude Code via [crosscheck](https://github.com/Motivation-Labs/crosscheck)._',
    '',
